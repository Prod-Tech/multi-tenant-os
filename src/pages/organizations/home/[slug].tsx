        ...
        return (
            ...
            <div>
                ...
                <li>
                    ...
                    <span className="group-hover:text-gray-700 dark:group-hover:text-gray-50">Directory</span>
                    </a>
                </li>
                <li>
                    <a
                    ...
                    <span className="group-hover:text-gray-700 dark:group-hover:text-gray-50" onClick={handleSettingsClicked}>Settings</span>
                    </a>
                </li>
                </ul>
            </div>

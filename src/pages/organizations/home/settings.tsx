...
const OrganizationSettings: NextPage = () => {
    ...
    return (
        ...
        <div className="px-6 pt-6 2xl:container">
            <div
                className="flex flex-col space-y-6 bg-white dark:bg-gray-800 p-6 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-600 h-[80vh] items-center justify-center"
            >
